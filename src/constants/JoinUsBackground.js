...
import {
  ...
  CafeOvalImage,
  CafeSquareImage,
} from '../components/JoinUs/Background/Background.styled';

export const images = [
  {
    name: 'PersonCircle',
    className: PersonCircleImage,
    jpg: personCircleJpg,
  ...
  {
    name: 'PersonTriangle',
    className: PersonTriangleImage,
    jpg: personTriangleJpg,
